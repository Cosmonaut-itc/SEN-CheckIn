...
- **Agregar resumen fiscal (1ª imagen, sin emojis) — recomendado**:
    ...
    - Nota: el cálculo de finiquito/liquidación en V1 es _bruto_; no modela impuestos del finiquito. Por eso, el resumen fiscal se toma de la última nómina (si existe) y no del finiquito.
