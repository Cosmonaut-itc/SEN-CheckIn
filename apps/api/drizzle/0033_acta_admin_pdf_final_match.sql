...
<div class="acta-admin" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.22; color: #000; width: 100%; margin: 0 auto;">
  ...
  <p style="margin: 0 0 98px 0; text-align: center; font-weight: 700;">
    {{employee.locationName}} {{acta.state}}, {{document.generatedDateLong}}
  </p>

  <p style="margin: 0 0 58px 0; text-align: center;">TRABAJADOR.</p>
  ...
  <table style="width: 100%; margin-top: 88px; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td style="padding-top: 78px; padding-left: 16px; text-align: right;">
