...
SET
	"html_content" =
$acta_pdf_final2$
<div class="acta-admin" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.22; color: #000; width: 100%; margin: 0 auto;">
  <p style="margin: 0 0 72px 0; text-align: center; font-weight: 700; font-size: 16px;">ACTA ADMINISTRATIVA</p>
  ...
  <p style="margin: 0 0 42px 0; text-align: center; white-space: pre-line;">-{{disciplinary.reason}}</p>

  <p style="margin: 0 0 98px 0; text-align: center;">
  ...
  <p style="margin: 0 0 88px 0; text-align: center; font-weight: 700;">
    {{employee.locationName}} {{acta.state}}, {{document.generatedDateLong}}
  </p>

  <p style="margin: 0 0 50px 0; text-align: center;">TRABAJADOR.</p>
  ...
  <table style="width: 100%; margin-top: 64px; border-collapse: collapse;">
    ...
    <tr>
      <td style="padding-top: 58px; padding-right: 16px;">
        <div style="border-top: 1px solid #000; width: 86%;"></div>
      </td>
      <td style="padding-top: 58px; padding-left: 16px; text-align: right;">
...
WHERE
	...
	AND "html_content" LIKE '%margin: 0 0 98px 0; text-align: center; font-weight: 700;%'
