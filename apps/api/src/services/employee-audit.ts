...
export function buildEmployeeAuditSnapshot(record: EmployeeRow): Record<string, unknown> {
	return {
		...
		fiscalDailyPay: record.fiscalDailyPay,
		paymentFrequency: record.paymentFrequency,
		employmentType: record.employmentType,
		isTrustEmployee: record.isTrustEmployee,
		isDirectorAdminGeneralManager: record.isDirectorAdminGeneralManager,
		isDomesticWorker: record.isDomesticWorker,
		isPlatformWorker: record.isPlatformWorker,
		platformHoursYear: record.platformHoursYear,
		ptuEligibilityOverride: record.ptuEligibilityOverride,
		aguinaldoDaysOverride: record.aguinaldoDaysOverride,
