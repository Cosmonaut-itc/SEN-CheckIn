import { parseDateKey, type ParsedDateKey } from './date-key.js';
 ...
 * @throws When the timezone is invalid
 */
...
export function getUtcDateForZonedMidnight(dateKey: string, timeZone: string): Date {
	...
	// Initial guess: treat the local calendar date as UTC midnight.
	const baseUtcMs = Date.UTC(year, month - 1, day, 0, 0, 0, 0);

	// Iterate to stabilize around DST changes.
