...
const envSchema = z.object({
	...
	EXPO_PUBLIC_WEB_VERIFY_URL: z
		.string()
		.url('EXPO_PUBLIC_WEB_VERIFY_URL must be a valid URL (e.g., http://localhost:3001/device)')
		.optional(),
	EXPO_PUBLIC_VERIFY_URL: z
		.string()
		.url('EXPO_PUBLIC_VERIFY_URL must be a valid URL (e.g., http://localhost:3001/device)')
		.optional(),
	VERIFY_URL: z
		.string()
		.url('VERIFY_URL must be a valid URL (e.g., http://localhost:3001/device)')
		.optional(),
});
