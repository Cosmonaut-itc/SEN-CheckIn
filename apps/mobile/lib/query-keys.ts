...
export const queryKeys = {
  locations: {
    ...
    list: (params?: ListQueryParams) => queryKeyConstructor(['locations', 'list'] as const, params),
    detail: (id: string) => ['locations', 'detail', id] as const,
  },
  devices: {
    all: ['devices'] as const,
    list: (params?: ListQueryParams) => queryKeyConstructor(['devices', 'list'] as const, params),
