...
const PRIMARY_DETAIL_TABS: EmployeeDetailTab[] = ['summary', 'attendance', 'vacations', 'documents'];
                ...
                <div className="relative">
                    <Input
                        ...
                        onChange={(event) => {
                            ...
                            if (isNextValid) {
                                setMonth(new Date(nextParsed.getFullYear(), nextParsed.getMonth(), 1));
                            }
                        }}
						...
						<div className="min-h-0 flex-1 overflow-hidden px-4 pb-4 min-[1025px]:px-6 min-[1025px]:pb-6">
							...
							<div className="flex h-full min-h-0 flex-col space-y-4 pt-4">
								...
								<div className={cn('rounded-md border p-4', isMobile && 'hidden min-[1025px]:block')}>
									...
									<div className="mt-4 grid gap-3 text-sm min-[1025px]:grid-cols-2 lg:grid-cols-4">
										<div className="space-y-1">
                                ...
                                <Tabs
                                    value={detailTab}
                                    onValueChange={(value) => handleDetailTabChange(value as EmployeeDialogTab)}
