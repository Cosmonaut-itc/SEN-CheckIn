...
> Regla de ingeniería: modela *finiquito* como un **módulo siempre-on** y *liquidación* como un **módulo condicional** (gobernado por `termination_reason` y `contract_type`).
...
{
  "salary": {
    "daily_salary_base": 500.00,
    "salary_is_variable": true,
    "variable_salary_reference": {
      "type": "avg_30_worked_days",
      "worked_days_counted": 30,
      "total_perceptions_in_period": 18000.00
    },
    "daily_salary_indemnizacion_lft": 600.00
  }
}
```
...
```json
{
  ...
  "breakdown": {
    "finiquito": {
      ...
      "vacation_pay": 3250.00,
      "vacation_premium": 812.50,
      "other_due": 0.00,
      "total_gross": 5932.36
    },
    "liquidacion": {
      "indemnizacion_3_meses": 54000.00,
      "indemnizacion_20_dias": 24000.00,
      "prima_antiguedad": 0.00,
      "total_gross": 78000.00
    }
  },
  "totals": {
