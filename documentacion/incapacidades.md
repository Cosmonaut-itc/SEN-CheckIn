...
> Nota: esta guía se centra en la *incidencia*. El desglose completo de cuotas IMSS está en tu documento IMSS/INFONAVIT/ISR/SAR.
...
```json
{
  ...
  "incapacity_summary": {
    ...
    "by_type": {
      "EG": {"days": 7, "subsidy_days": 4, "subsidy_rate": 0.60},
      "RT": {"days": 0},
      "MAT": {"days": 0},
      "LIC140BIS": {"days": 0}
    }
  ...
  "salary_effect": {
    ...
    "salary_amount_paid_by_employer": 0.00,
    "employer_complements": []
  },
  "imss_subsidy": {
    "payment_mode": "direct",
    "expected_subsidy_amount": 702.00,
    "informational_only": true
  },
  "social_security_effects": {
    "imss_exempt_days_except_retiro": 7,
    "retiro_pat_incapacity": 0.00,
    "infonavit_5_includes_incapacity_days": true
  },
  "cfdi_nomina": {
    "incapacidades": [
      {"dias": 7, "tipo": "02", "importe_monetario": 0.00}
    ]
  }
}
```
...
- Subsidio = 500 * 0.60 * 3 = 900

### Test C: RT 10 días
- Subsidio = SBC * 1.00 * 10

### Test D: MAT 84 días
- Subsidio = SBC * 1.00 * 84  
...
- **IMSS-01-036-C** — Convenio de *pago indirecto y reembolso de subsidios*: https://www.imss.gob.mx/tramites/imss01036c  
